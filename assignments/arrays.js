...
console.log(`Last car info | Make: ${inventory[lastCar].car_make}  Model: ${inventory[lastCar].car_model}`);
...
let oldCars = inventory.filter(car => car.car_year < 2000).map(a => a.car_year);
console.log(oldCars);
